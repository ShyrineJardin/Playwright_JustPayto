...
const CREDENTIALS = {
    ...
    apiUsername: process.env.API_USERNAME_PAGE || process.env.INDIVIDUAL_API_USERNAME || 'end-users',
};
...
test.describe('🔐 Authentication — /access-token/generate', () => {
    ...
    test('POST returns 401 when Authorization header is missing', async ({ request }) => {
    ...
    test('POST returns 401 when apiUsername header is missing', async ({ request }) => {
