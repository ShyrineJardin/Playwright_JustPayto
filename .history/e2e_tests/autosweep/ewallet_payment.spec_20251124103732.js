...
test('🤲 eWallet payment for Autosweep', async ({page, context, baseURL, browserName, playwright}) => {
    test.setTimeout(120000);

    console.log('🚗 Complete eWallet Payment Flow for autosweep');
   ...
   console.log('📢 Close the Autosweep Announcement Modal')
    ...
    console.log('🔍 Verifying plate number in readonly display field...');
        ...
        expect(paymentMethod).toContain('H');
