...
test('🏦 Online bank payment for business user - pickup', async ({page, context, baseURL, browserName, playwright}) => {
    test.setTimeout(120000);

    console.log('💻 Complete Online Bank Payment Flow for business - pickup');
    ...
    const testMessage = 'OnlineBankBusinessPickUpTest12345';
    ...
    await expect(page.getByText('OnlineBankBusinessPickUpTest12345')).toBeVisible();
