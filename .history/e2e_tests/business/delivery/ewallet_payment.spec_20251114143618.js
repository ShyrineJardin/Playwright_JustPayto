...
test('🏦 eWallet payment for business user - delivery', async ({page, context, baseURL, browserName, playwright}) => {
    test.setTimeout(120000);

    console.log('💻 Complete eWallet Payment Flow for business - delivery');
    ...
    const isButtonVisible = await payNowButton.isVisible({timeout: 60000}).catch(() => false);
    ...
    const testMessage = 'eWalletBusinessDeliveryTest12345';
    ...
    await expect(page.getByText('eWalletBusinessDeliveryTest12345')).toBeVisible();
