...
if (!mobileValue || mobileValue.trim() === '') {
    ...
    await expect(popup).toContain('Mastercard/Visa Verification');

    console.log('🔃 Waiting for the confirmation popup');
    await expect(popup).toContain('Transaction Successful')
