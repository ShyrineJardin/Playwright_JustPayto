...
test('🏦 Bank Transfer payment for individual user', async ({page, context, baseURL, browserName, playwright}) => {
    ...
    // Find the Continue button in the modal (should be enabled after checking the box)
console.log('👆 Looking for enabled Continue button in modal');

// Wait a moment for the button to become enabled after checking the checkbox
await page.waitForTimeout(1000);

// Click the Continue button (should be enabled now)
