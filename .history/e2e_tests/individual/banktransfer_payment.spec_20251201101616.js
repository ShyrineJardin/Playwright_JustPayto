...
test('🏦 Bank Transfer payment for individual user', async ({page, context, baseURL, browserName, playwright}) => {
    ...
    // Wait for page to transition to OTP step (may take longer in headed mode)
    await page.waitForTimeout(2000);
    ...
    // ============================================================================
    // COMMENTED EMAIL VERIFICATION EXAMPLES FOR OTHER MERCHANT TYPES
    // Uncomment and adapt these for your other test scenarios
    // ============================================================================

    // --- BUSINESS USER EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for business user...');
    // await page.waitForTimeout(2000);
    // const businessUserEmail = await checkEmail({
    //     from: 'hello@justpay.to',
    ...
    //     after: searchTime1.toISOString(),
    // });
    // if (!businessUserEmail) {
    //     throw new Error(`❌ No confirmation email received for business user: ${process.env.BUSINESS_USER_EMAIL}`);
    // }
    // console.log('✅ Business user confirmation email received.');
    // console.log(`📧 To: ${process.env.BUSINESS_USER_EMAIL}`);
    // console.log(`🕒 Received at: ${businessUserEmail.date || 'unknown'}`);

    // --- BUSINESS MERCHANT EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for business merchant...');
    // await page.waitForTimeout(2000);
    // const businessMerchantEmail = await checkMerchantEmail({
    //     from: 'hello@justpay.to',
    ...
    //     after: searchTime2.toISOString(),
    // });
    // if (!businessMerchantEmail) {
    //     throw new Error(`❌ No confirmation email received for business merchant: ${process.env.BUSINESS_MERCHANT_EMAIL}`);
    // }
    // console.log('✅ Business merchant confirmation email received.');
    // console.log(`📧 To: ${process.env.BUSINESS_MERCHANT_EMAIL}`);
    // console.log(`🕒 Received at: ${businessMerchantEmail.date || 'unknown'}`);

    // --- BAYADCENTER USER EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for bayadcenter user...');
    // await page.waitForTimeout(2000);
    // const bayadcenterUserEmail = await checkEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.BAYADCENTER_USER_EMAIL,
    //     subject: 'You are sending',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime1.toISOString(),
    // });
    // if (!bayadcenterUserEmail) {
    //     throw new Error(`❌ No confirmation email received for bayadcenter user: ${process.env.BAYADCENTER_USER_EMAIL}`);
    // }
    // console.log('✅ Bayadcenter user confirmation email received.');
    // console.log(`📧 To: ${process.env.BAYADCENTER_USER_EMAIL}`);
    // console.log(`🕒 Received at: ${bayadcenterUserEmail.date || 'unknown'}`);

    // --- BAYADCENTER MERCHANT EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for bayadcenter merchant...');
    // await page.waitForTimeout(2000);
    // const bayadcenterMerchantEmail = await checkMerchantEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.BAYADCENTER_MERCHANT_EMAIL,
    //     subject: 'You are receiving',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime2.toISOString(),
    // });
    // if (!bayadcenterMerchantEmail) {
    //     throw new Error(`❌ No confirmation email received for bayadcenter merchant: ${process.env.BAYADCENTER_MERCHANT_EMAIL}`);
    // }
    // console.log('✅ Bayadcenter merchant confirmation email received.');
    // console.log(`📧 To: ${process.env.BAYADCENTER_MERCHANT_EMAIL}`);
    // console.log(`🕒 Received at: ${bayadcenterMerchantEmail.date || 'unknown'}`);

    // --- DONATION USER EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for donation user...');
    // await page.waitForTimeout(2000);
    // const donationUserEmail = await checkEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.DONATION_USER_EMAIL,
    //     subject: 'You are sending',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime1.toISOString(),
    // });
    // if (!donationUserEmail) {
    //     throw new Error(`❌ No confirmation email received for donation user: ${process.env.DONATION_USER_EMAIL}`);
    // }
    // console.log('✅ Donation user confirmation email received.');
    // console.log(`📧 To: ${process.env.DONATION_USER_EMAIL}`);
    // console.log(`🕒 Received at: ${donationUserEmail.date || 'unknown'}`);

    // --- DONATION MERCHANT EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for donation merchant...');
    // await page.waitForTimeout(2000);
    // const donationMerchantEmail = await checkMerchantEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.DONATION_MERCHANT_EMAIL,
    //     subject: 'You are receiving',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime2.toISOString(),
    // });
    // if (!donationMerchantEmail) {
    //     throw new Error(`❌ No confirmation email received for donation merchant: ${process.env.DONATION_MERCHANT_EMAIL}`);
    // }
    // console.log('✅ Donation merchant confirmation email received.');
    // console.log(`📧 To: ${process.env.DONATION_MERCHANT_EMAIL}`);
    // console.log(`🕒 Received at: ${donationMerchantEmail.date || 'unknown'}`);

    // --- AUTOSWEEP USER EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for autosweep user...');
    // await page.waitForTimeout(2000);
    // const autosweepUserEmail = await checkEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.AUTOSWEEP_USER_EMAIL,
    //     subject: 'You are sending',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime1.toISOString(),
    // });
    // if (!autosweepUserEmail) {
    //     throw new Error(`❌ No confirmation email received for autosweep user: ${process.env.AUTOSWEEP_USER_EMAIL}`);
    // }
    // console.log('✅ Autosweep user confirmation email received.');
    // console.log(`📧 To: ${process.env.AUTOSWEEP_USER_EMAIL}`);
    // console.log(`🕒 Received at: ${autosweepUserEmail.date || 'unknown'}`);

    // --- AUTOSWEEP MERCHANT EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for autosweep merchant...');
    // await page.waitForTimeout(2000);
    // const autosweepMerchantEmail = await checkMerchantEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.AUTOSWEEP_MERCHANT_EMAIL,
    //     subject: 'You are receiving',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime2.toISOString(),
    // });
    // if (!autosweepMerchantEmail) {
    //     throw new Error(`❌ No confirmation email received for autosweep merchant: ${process.env.AUTOSWEEP_MERCHANT_EMAIL}`);
    // }
    // console.log('✅ Autosweep merchant confirmation email received.');
    // console.log(`📧 To: ${process.env.AUTOSWEEP_MERCHANT_EMAIL}`);
    // console.log(`🕒 Received at: ${autosweepMerchantEmail.date || 'unknown'}`);

    // --- MERALCO USER EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for meralco user...');
    // await page.waitForTimeout(2000);
    // const meralcoUserEmail = await checkEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.MERALCO_USER_EMAIL,
    //     subject: 'You are sending',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime1.toISOString(),
    // });
    // if (!meralcoUserEmail) {
    //     throw new Error(`❌ No confirmation email received for meralco user: ${process.env.MERALCO_USER_EMAIL}`);
    // }
    // console.log('✅ Meralco user confirmation email received.');
    // console.log(`📧 To: ${process.env.MERALCO_USER_EMAIL}`);
    // console.log(`🕒 Received at: ${meralcoUserEmail.date || 'unknown'}`);

    // --- MERALCO MERCHANT EMAIL VERIFICATION ---
    // console.log('📬 Waiting for confirmation email for meralco merchant...');
    // await page.waitForTimeout(2000);
    // const meralcoMerchantEmail = await checkMerchantEmail({
    //     from: 'hello@justpay.to',
    //     to: process.env.MERALCO_MERCHANT_EMAIL,
    //     subject: 'You are receiving',
    //     wait_time_sec: 20,
    //     max_wait_time_sec: 180,
    //     after: searchTime2.toISOString(),
    // });
    // if (!meralcoMerchantEmail) {
    //     throw new Error(`❌ No confirmation email received for meralco merchant: ${process.env.MERALCO_MERCHANT_EMAIL}`);
    // }
    // console.log('✅ Meralco merchant confirmation email received.');
    // console.log(`📧 To: ${process.env.MERALCO_MERCHANT_EMAIL}`);
    // console.log(`🕒 Received at: ${meralcoMerchantEmail.date || 'unknown'}`);
