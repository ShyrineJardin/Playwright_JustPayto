...
test('🏦 Bank Transfer payment for individual user', async ({page, context, baseURL, browserName, playwright}) => {
    ...
    console.log('🔗 Redirecting to MoneyBank mock page window popup ...')

    console.log('🔗 Waiting for MoneyBank button to appear...')
await page.locator('button', { hasText: 'MoneyBank' }).waitFor({ state: 'visible', timeout: 15000 });
